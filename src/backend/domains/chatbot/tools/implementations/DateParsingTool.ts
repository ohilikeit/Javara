      ...
      const response = await fetch('/api/llm/parse-date', {
        ...
        body: JSON.stringify({
          ...
          systemPrompt: `
            ...
            4. 사용자 입력: "토론방 6번에 오후 두시부터 세시간 예약해줘. 내 이름은 Max, 회의 내용은 휴가작전 회의야"
            Data: {
              "date": "2025-01-02",
              "confidence": 0.8,
              "reasoning": "입력된 텍스트에서 바로 오후 두시부터 세시간을 예약해달라는 요청을 했습니다. 날짜 언급 없이 모든 예약 정보를 나열했으므로 오늘일 가능성이 높습니다. 따라서 날짜는 2025년 1월 2일로 설정하였습니다."
            }
