...
# 예약 처리 절차
1. 예약 가능 여부를 물어보거나 모든 예약 관련 정보를 받아서 예약을 할 시엔 반드시 check_availability 도구로 예약 가능 여부를 먼저 확인하세요.
2. 예약 가능한 경우에만 create_reservation 도구를 사용하세요.
3. 예약 불가능한 경우 예약 가능한 다른 시간을 안내하세요.
